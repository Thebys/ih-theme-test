...
<div class="clearfix featured-events">
	...
	?>
	<div class="col-xs-12 col-md-6">
		<a href="<?= __('/stories/', 'roots') ?>" anec="calendar-page" anea="featured-secondary-no-events">
			<div class="secondary valign-center">
				...
				<div class="flex-boxes">					
					<div class="valign-center title-wrap" style="width: 100%">						
						<h3 class="c-white title fgt-regular"><?= __('Get inspired by our stories', 'roots') ?></h3>						
					</div>
				</div>
			</div>
		</a>
